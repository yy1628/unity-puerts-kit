...
- Visual Studio Code
- Unity 2021.3.6.f1c1
- FairyGUI (UI编辑器，如果只需要启动项目，可以不用装)
1. 克隆该项目，项目结构如下
    - `src` TypeScript 脚本目录
    - `GUI` FairyGUI 项目目录
    - `csharp` C# 代码目录
...
2. [下载 puerts 的二进制库](https://github.com/Tencent/puerts/releases)，并解压到`Assets`目录下 (目前版本PuerTS_V8_1.4.0-preview.6)
...
5. 使用 VSCode 打开该项目，执行以下 npm 命令编译 JavaScript 库
    - `npm run webapi:dev:` 或 `yarn webapi:dev` 编译 WebAPI 兼容库
